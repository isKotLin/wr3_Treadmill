...
import com.vigorchip.treadmill.module.Pickers;
...
//    private int mColorText = 0x333333;
    ...
    private void init() {
        ...
        mPaint.setTextAlign(Paint.Align.CENTER);//mPaint.setColor(mColorText);
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        for (int i = 1; (mCurrentSelected - i) >= 0; i++) {// 绘制上方data
            drawOtherText(canvas, i, -1);
        }
        for (int i = 1; (mCurrentSelected + i) < mDataList.size(); i++) {// 绘制下方data
            drawOtherText(canvas, i, 1);
        }
    }
